...
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.IsDev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
...
func (c *authClient) AuthUser(ctx context.Context, in *AuthUserRequest, opts ...grpc.CallOption) (*AuthUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, Auth_AuthUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
